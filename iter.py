...
if __name__ == "__main__":
    ...
    with open("execution_times.txt", "a") as f:
        ...
        for iteration in range(1, num_iterations + 1):
            ...
            multi_threaded_executable = f'mark3'
            single_threaded_executable = f'mark3single'
            
            total_single_threaded_time = 0
            total_multi_threaded_time = 0
            
            single_threaded_time = compile_and_run(single_threaded_executable, 'mark3single.cpp', iteration, max_iterations_per_thread, tabu_list_size, json_file_name )
            multi_threaded_time = compile_and_run(multi_threaded_executable, 'mark3.cpp', iteration, max_iterations_per_thread, tabu_list_size, json_file_name )
